    ...
    <PostContainer>
      <PostHeader>
        ...
        <PostHeaderChips>
          ...
          <Text component="span">
            <Icon icon={faComment} />5 comentários
          </Text>
        </PostHeaderChips>
      </PostHeader>
